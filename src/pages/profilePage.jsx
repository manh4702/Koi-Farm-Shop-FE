...
const ProfilePage = () => {
  ...
  const renderContent = () => {
    switch (selectedSection) {
      ...
      case "favorites":
        return <div>Favorite Products Content</div>;
      default:
        return <UserProfilePage />;
    }
  };
      ...
      <div className="profile-container">
        <div className="sidebar">
          ...
          <ul>
            ...
            >
              <FaHistory style={{ marginRight: "8px", fontSize: "24px" }} />{" "}
            ...
            >
              <MdFeedback style={{ marginRight: "8px", fontSize: "24px" }} />{" "}
              {/* Adjusted icon size and margin */}
              Đánh giá của tôi
            </li>
            <li
            ...
            >
              <FaFish style={{ marginRight: "8px", fontSize: "24px" }} />{" "}
              {/* Adjusted icon size and margin */}
              Sản phẩm yêu thích
            </li>
          </ul>
        ...
        <div className="profile-details">
          ...
          <p style={{ fontSize: "20px" }}>
            Tên đăng nhập: {user ? user.name : "Loading..."}
          </p>
          {/*  <p>Email: {user ? user.email : 'Loading...'}</p>
                    <p>Số điện thoại: {user ? user.phone : 'Loading...'}</p> */}
          <p style={{ fontSize: "20px" }}>
            Role khách hàng: {user ? user.role : "Loading..."}
          </p>
