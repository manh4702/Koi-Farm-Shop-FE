  ...
  const [fishes, setFishes] = useState([
    {
      ...
      foodQuantity: "10",
      screeningRate: "95%",
      image: "https://www.bing.com/th?id=OIP.Ya3VaVVCB_Y_3Y-5KTaKTwHaGR&w=189&h=150&c=8&rs=1&qlt=90&r=0&o=6&pid=3.1&rm=2",
      description: "Cá Koi Kohaku là một loại cá nổi tiếng của Nhật Bản với màu trắng và đỏ đặc trưng.",
      secondaryImages: [],
    },
    // Các cá khác...
  ]);
            ...
            >
              ...
              <Row gutter={16}>
                <Col span={12}>
                  ...
                  <Form.Item label="Nguồn gốc" name="origin" rules={[{ required: true, message: "Vui lòng nhập nguồn gốc của cá" }]}>
                    <Select>
                  ...
                  <Form.Item label="Giới tính" name="gender" rules={[{ required: true, message: "Vui lòng nhập giới tính của cá" }]}>
                    <Select>
                      <Select.Option value="Đực">Đực</Select.Option>
                      <Select.Option value="Cái">Cái</Select.Option>
                    </Select>
                  </Form.Item>
                  <Form.Item label="Tuổi (năm)" name="age" rules={[{ required: true, message: "Vui lòng nhập tuổi của cá" }]}>
                    <InputNumber min={0} />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <Form.Item label="Kích thước (cm)" name="size" rules={[{ required: true, message: "Vui lòng nhập kích thước của cá" }]}>
                    <Input />
                  </Form.Item>
                  <Form.Item label="Giống" name="breed" rules={[{ required: true, message: "Vui lòng nhập giống của cá" }]}>
                    <Select>
                  ...
                  <Form.Item label="Lượng thức ăn/ngày (gram)" name="foodQuantity" rules={[{ required: true, message: "Vui lòng nhập lượng thức ăn của cá" }]}>
                    <Input />
                  </Form.Item>
                  <Form.Item label="Tỉ lệ sàng lọc" name="screeningRate" rules={[{ required: true, message: "Vui lòng nhập tỉ lệ sàng lọc của cá" }]}>
                    <Input />
                  </Form.Item>
                </Col>
              </Row>
            ...
            <Card title={`Chi tiết của ${selectedFish.name}`}>
              <Tabs defaultActiveKey="1">
                <TabPane tab="Thông tin Cá" key="1">
                  <Row gutter={16}>
                    <Col span={24}>
                      <img src={selectedFish.image} alt="fish" style={{ width: "20%", height: "auto", marginBottom: "20px" }} />
                    </Col>
                    <Col span={12}>
